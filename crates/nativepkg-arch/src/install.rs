...
const SNIPPETS: &[(&str, &str)] = &[
    ("account", include_str!("../snippets/account")),
    ("logdir", include_str!("../snippets/logdir")),
    ("npm-install", include_str!("../snippets/npm-install")),
    ("systemd-reload", include_str!("../snippets/systemd-reload")),
    ("systemd-enable", include_str!("../snippets/systemd-enable")),
    (
        "systemd-restart",
        include_str!("../snippets/systemd-restart"),
    ),
    ("systemd-start", include_str!("../snippets/systemd-start")),
    ("systemd-stop", include_str!("../snippets/systemd-stop")),
    ("purge", include_str!("../snippets/purge")),
];
