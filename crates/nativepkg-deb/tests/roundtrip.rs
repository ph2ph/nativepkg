...
use nativepkg_deb::read::EntryKind;
use nativepkg_deb::{Compression, Options, build_bytes, read};
...
fn an_explicit_directory_entry_is_packaged_with_its_own_mode() {
    let restricted = PlannedFile {
        ...
        kind: nativepkg_core::plan::EntryKind::Directory,
        content: nativepkg_core::plan::FileContent::None,
        mode: 0o700,
        is_config: false,
    };
