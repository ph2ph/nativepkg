...
const SNIPPETS: &[(&str, &str)] = &[
    (
        "postinst-account",
        include_str!("../../snippets/deb/postinst-account"),
    ),
    (
        "postinst-logdir",
        include_str!("../../snippets/deb/postinst-logdir"),
    ),
    (
        "postinst-npm-install",
        include_str!("../../snippets/deb/postinst-npm-install"),
    ),
    (
        "postinst-systemd-enable",
        include_str!("../../snippets/deb/postinst-systemd-enable"),
    ),
    (
        "postinst-systemd-restart",
        include_str!("../../snippets/deb/postinst-systemd-restart"),
    ),
    (
        "postinst-sysv",
        include_str!("../../snippets/deb/postinst-sysv"),
    ),
    (
        "postinst-upstart",
        include_str!("../../snippets/deb/postinst-upstart"),
    ),
    (
        "postrm-purge",
        include_str!("../../snippets/deb/postrm-purge"),
    ),
    (
        "postrm-systemd",
        include_str!("../../snippets/deb/postrm-systemd"),
    ),
    (
        "postrm-systemd-reload",
        include_str!("../../snippets/deb/postrm-systemd-reload"),
    ),
    (
        "postrm-sysv",
        include_str!("../../snippets/deb/postrm-sysv"),
    ),
    (
        "prerm-systemd-restart",
        include_str!("../../snippets/deb/prerm-systemd-restart"),
    ),
    ("prerm-sysv", include_str!("../../snippets/deb/prerm-sysv")),
    (
        "prerm-upstart",
        include_str!("../../snippets/deb/prerm-upstart"),
    ),
];
