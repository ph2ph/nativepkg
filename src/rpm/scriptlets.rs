...
const SNIPPETS: &[(&str, &str)] = &[
    (
        "pre-account",
        include_str!("../../snippets/rpm/pre-account"),
    ),
    (
        "post-logdir",
        include_str!("../../snippets/rpm/post-logdir"),
    ),
    (
        "post-npm-install",
        include_str!("../../snippets/rpm/post-npm-install"),
    ),
    (
        "post-systemd",
        include_str!("../../snippets/rpm/post-systemd"),
    ),
    (
        "preun-systemd",
        include_str!("../../snippets/rpm/preun-systemd"),
    ),
    (
        "postun-systemd",
        include_str!("../../snippets/rpm/postun-systemd"),
    ),
    (
        "postun-purge",
        include_str!("../../snippets/rpm/postun-purge"),
    ),
    ("post-sysv", include_str!("../../snippets/rpm/post-sysv")),
    ("preun-sysv", include_str!("../../snippets/rpm/preun-sysv")),
];
