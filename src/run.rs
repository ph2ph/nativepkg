...
use crate::core::npm::Settings;
use crate::core::plan::BuildPlan;
use crate::core::resolve::{Overrides, ResolvedConfig, Warning};
use crate::core::{Manifest, build, resolve};
...
fn generate(
    plan: &BuildPlan,
    config: &ResolvedConfig,
    variables: &crate::core::template::Variables,
    overrides: &[(&'static str, &Path)],
) -> Result<BuildPlan> {
